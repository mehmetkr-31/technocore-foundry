...
export default function DealsPage() {
  return <main className="artifact-page deals-page">
    ...
    <section className="readiness-next"><h2>Görev ve anlaşmayı tek dosyada sakla</h2><p>Foundry dossier’ını TCLK kaydıyla eşleştir; tarafları ve imzalı görev bağlantısını doğrula.</p><Link className="button button-primary" href="/deals/bundle">Birleşik kanıt oluştur →</Link></section>
    <TclkInspector />
