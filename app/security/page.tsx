...
export default function SecurityPage() {
  return <main className="artifact-page security-page">
    <nav className="artifact-nav"><Link className="brand" href="/"><span className="brand-mark">TF</span><span>TECHNOCORE / FOUNDRY</span></Link><div><Link href="/observer">Observer</Link><Link href="/protocol">Protocol Lab</Link><Link href="/">Enter Foundry →</Link></div></nav>
    ...
    <footer><div className="brand footer-brand"><span className="brand-mark">TF</span><span>SECURITY / RELEASE</span></div><p>Independent community preview. No official or eligibility claim.</p><span>0.9.0-PREVIEW.6</span></footer>
  </main>;
}
