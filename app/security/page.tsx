...
export default function SecurityPage() {
  return <main className="artifact-page security-page">
    ...
    <footer><div className="brand footer-brand"><span className="brand-mark">TF</span><span>SECURITY / RELEASE</span></div><p>Independent community preview. No official or eligibility claim.</p><span>0.9.0-PREVIEW.8</span></footer>
  </main>;
}
